...
**Architecture:** Add a Node script under `scripts/` that uses the existing frontend Playwright dependency. The script logs into the local MiniAdmin web app, visits a curated showcase route list, captures screenshots into `docs-site/public/screenshots/features`, and writes machine-readable metadata for docs reuse.
...
- Create: `docs-site/public/screenshots/features/.gitkeep`
- Create: `docs-site/public/screenshots/features/screenshots.json`
...
- [ ] Save screenshots under `docs-site/public/screenshots/features`.
...
**Files:**
- Verify generated screenshots in `docs-site/public/screenshots/features`.
